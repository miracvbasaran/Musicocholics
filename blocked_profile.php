<?php
    ...
    $blocked_id = $_GET['choosed_user_id'];
    $query2 = "SELECT * FROM user WHERE user_id = '$blocked_id' ";
    ...
    {
      $query3 = "DELETE FROM blocks WHERE ($uid = blocker_id AND $blocked_id = blocked_id ) OR  ($blocked_id = blocker_id AND $uid = blocked_id )";
      header("location: nonfriend_profile.php?choosed_user_id=$blocked_id");
    }
...
<div class="container">
  ...
  <h3>This is, </h3> <?php echo $fullname_b;?>
  	<p> 
