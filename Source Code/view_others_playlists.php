...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<p>
				<?php
					$queryOP = "SELECT P.playlist_name FROM Playlist P WHERE P.creator_id = '$other_id' "
			...
			<h3> Followed Playlists: </h3> <br>
			<p>
				<?php
					$queryFP = "SELECT P.playlist_name FROM Playlist P , Follows F WHERE F.user_id = '$other_id' AND F.playlist_id = P.playlist_id"
